        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SearchesCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserSessionId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WeatherCache", x => x.CityName);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteCities_AddedAt",
                table: "FavoriteCities",
                column: "AddedAt");

            migrationBuilder.CreateIndex(
                name: "IX_FavoriteCities_CityName_UserSessionId",
                table: "FavoriteCities",
                columns: new[] { "CityName", "UserSessionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FavoriteCities_UserSessionId",
                table: "FavoriteCities",
                column: "UserSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_SearchHistory_CityName",
                table: "SearchHistory",
                column: "CityName");
